...
iOS Developer 오픈 카톡을 보다가 어떤 한 분이 [Swift API Design Guidelines](https://www.swift.org/documentation/api-design-guidelines) 내용을 잘 정리해주신 [홍성호님의 인프런 강의](https://www.inflearn.com/course/읽기-좋은-스위프트)를 만들었다고 올려주셔서 구매해서 듣게되었는데...
